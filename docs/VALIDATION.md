...
Checked on 2026-09-23 against the **local deterministic mock** only. These results do not establish Nebius, NVIDIA, cloud-model, account, deployment, competition, payment, or submission outcomes.
